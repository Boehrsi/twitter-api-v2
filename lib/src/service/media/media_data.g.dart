...
_MediaData _$MediaDataFromJson(Map json) => $checkedCreate(
  '_MediaData',
  json,
  ($checkedConvert) {
    final val = _MediaData(
      key: $checkedConvert('media_key', (v) => v as String),
      type: $checkedConvert('type', (v) => $enumDecode(_$MediaTypeEnumMap, v)),
      url: $checkedConvert('url', (v) => v as String?),
      altText: $checkedConvert('alt_text', (v) => v as String?),
      durationMilliseconds: $checkedConvert(
        'duration_ms',
        (v) => (v as num?)?.toInt(),
      ),
      ...
      privateMetrics: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : PrivateMediaMetrics.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      organicMetrics: $checkedConvert(
        'organic_metrics',
        (v) => v == null
            ? null
            : OrganicMediaMetrics.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      previewImageUrl: $checkedConvert(
        'preview_image_url',
        (v) => v as String?,
      ),
      ...
      publicMetrics: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : PublicMediaMetrics.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      variants: $checkedConvert(
        'variants',
        (v) => (v as List<dynamic>?)
            ?.map((e) => Variant.fromJson(Map<String, Object?>.from(e as Map)))
            .toList(),
      ),
    );
    return val;
...
Map<String, dynamic> _$MediaDataToJson(_MediaData instance) =>
    <String, dynamic>{
