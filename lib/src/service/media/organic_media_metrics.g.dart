...
_OrganicMediaMetrics _$OrganicMediaMetricsFromJson(Map json) => $checkedCreate(
  '_OrganicMediaMetrics',
  json,
  ($checkedConvert) {
    final val = _OrganicMediaMetrics(
      playback0Count: $checkedConvert(
        'playback_0_count',
        (v) => (v as num).toInt(),
      ),
      playback25Count: $checkedConvert(
        'playback_25_count',
        (v) => (v as num).toInt(),
      ),
      playback50Count: $checkedConvert(
        'playback_50_count',
        (v) => (v as num).toInt(),
      ),
      playback75Count: $checkedConvert(
        'playback_75_count',
        (v) => (v as num).toInt(),
      ),
      playback100Count: $checkedConvert(
        'playback_100_count',
        (v) => (v as num).toInt(),
      ),
...
Map<String, dynamic> _$OrganicMediaMetricsToJson(
  _OrganicMediaMetrics instance,
) => <String, dynamic>{
