...
_PrivateMediaMetrics _$PrivateMediaMetricsFromJson(Map json) => $checkedCreate(
  '_PrivateMediaMetrics',
  json,
  ($checkedConvert) {
    final val = _PrivateMediaMetrics(
...
Map<String, dynamic> _$PrivateMediaMetricsToJson(
  _PrivateMediaMetrics instance,
) => <String, dynamic>{
