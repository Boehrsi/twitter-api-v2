...
_PromotedMediaMetrics _$PromotedMediaMetricsFromJson(Map json) =>
    $checkedCreate(
      '_PromotedMediaMetrics',
      json,
      ($checkedConvert) {
        final val = _PromotedMediaMetrics(
...
Map<String, dynamic> _$PromotedMediaMetricsToJson(
  _PromotedMediaMetrics instance,
) => <String, dynamic>{
