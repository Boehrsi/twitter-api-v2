...
_UploadedMediaData _$UploadedMediaDataFromJson(Map json) => $checkedCreate(
  '_UploadedMediaData',
  json,
  ($checkedConvert) {
    final val = _UploadedMediaData(
...
Map<String, dynamic> _$UploadedMediaDataToJson(_UploadedMediaData instance) =>
    <String, dynamic>{
