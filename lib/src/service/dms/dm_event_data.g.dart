...
_DMEventData _$DMEventDataFromJson(Map json) => $checkedCreate(
  '_DMEventData',
  json,
  ($checkedConvert) {
    final val = _DMEventData(
      id: $checkedConvert('id', (v) => v as String),
      eventType: $checkedConvert(
        'event_type',
        (v) => $enumDecode(_$DMEventTypeEnumMap, v),
      ),
      ...
      attachments: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : DMAttachments.fromJson(Map<String, Object?>.from(v as Map)),
      ),
...
Map<String, dynamic> _$DMEventDataToJson(_DMEventData instance) =>
    <String, dynamic>{
      'id': instance.id,
