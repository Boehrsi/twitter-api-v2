...
_PlaceData _$PlaceDataFromJson(Map json) => $checkedCreate(
  '_PlaceData',
  json,
  ($checkedConvert) {
    final val = _PlaceData(
      id: $checkedConvert('id', (v) => v as String),
      fullName: $checkedConvert('full_name', (v) => v as String),
      name: $checkedConvert('name', (v) => v as String?),
      placeType: $checkedConvert(
        'place_type',
        (v) => $enumDecodeNullable(_$PlaceTypeEnumMap, v),
      ),
      ...
      containedWithin: $checkedConvert(
        'contained_within',
...
Map<String, dynamic> _$PlaceDataToJson(_PlaceData instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'country_code': ?_$CountryEnumMap[instance.country],
