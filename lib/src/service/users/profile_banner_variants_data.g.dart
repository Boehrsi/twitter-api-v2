...
_ProfileBannerVariantsData _$ProfileBannerVariantsDataFromJson(
  Map json,
) => $checkedCreate(
  '_ProfileBannerVariantsData',
  json,
  ($checkedConvert) {
    final val = _ProfileBannerVariantsData(
      ipad: $checkedConvert(
        'ipad',
        (v) =>
            ProfileBannerVariant.fromJson(Map<String, Object?>.from(v as Map)),
      ),
...
Map<String, dynamic> _$ProfileBannerVariantsDataToJson(
  _ProfileBannerVariantsData instance,
) => <String, dynamic>{
