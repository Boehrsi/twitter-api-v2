...
_OrganicTweetMetrics _$OrganicTweetMetricsFromJson(Map json) => $checkedCreate(
  '_OrganicTweetMetrics',
  json,
  ($checkedConvert) {
    final val = _OrganicTweetMetrics(
...
Map<String, dynamic> _$OrganicTweetMetricsToJson(
  _OrganicTweetMetrics instance,
) => <String, dynamic>{
