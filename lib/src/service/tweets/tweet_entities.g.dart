...
_TweetEntities _$TweetEntitiesFromJson(Map json) => $checkedCreate(
  '_TweetEntities',
  json,
  ($checkedConvert) {
    final val = _TweetEntities(
      annotations: $checkedConvert(
        'annotations',
        (v) => (v as List<dynamic>?)
            ?.map(
              (e) =>
                  TweetAnnotation.fromJson(Map<String, Object?>.from(e as Map)),
            )
            .toList(),
      ),
      ...
      mentions: $checkedConvert(
        'mentions',
        (v) => (v as List<dynamic>?)
            ?.map((e) => Mention.fromJson(Map<String, Object?>.from(e as Map)))
            .toList(),
      ),
      urls: $checkedConvert(
        'urls',
...
Map<String, dynamic> _$TweetEntitiesToJson(_TweetEntities instance) =>
    <String, dynamic>{
