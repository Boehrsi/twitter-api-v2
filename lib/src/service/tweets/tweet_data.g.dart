...
_TweetData _$TweetDataFromJson(Map json) => $checkedCreate(
  '_TweetData',
  json,
  ($checkedConvert) {
    final val = _TweetData(
      id: $checkedConvert('id', (v) => v as String),
      text: $checkedConvert('text', (v) => v as String),
      authorId: $checkedConvert('author_id', (v) => v as String?),
      inReplyToUserId: $checkedConvert(
        'in_reply_to_user_id',
        (v) => v as String?,
      ),
      ...
      referencedTweets: $checkedConvert(
        ...
        (v) => (v as List<dynamic>?)
            ?.map(
              (e) =>
                  ReferencedTweet.fromJson(Map<String, Object?>.from(e as Map)),
            )
            .toList(),
      ),
      contextAnnotations: $checkedConvert(
        ...
        (v) => (v as List<dynamic>?)
            ?.map(
              (e) => TweetContextAnnotationGroup.fromJson(
      ...
      entities: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : TweetEntities.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      attachments: $checkedConvert(
        'attachments',
        (v) => v == null
            ? null
            : TweetAttachments.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      privateMetrics: $checkedConvert(
        'non_public_metrics',
        (v) => v == null
            ? null
            : PrivateTweetMetrics.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      organicMetrics: $checkedConvert(
        'organic_metrics',
        (v) => v == null
            ? null
            : OrganicTweetMetrics.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      ...
      publicMetrics: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : PublicTweetMetrics.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      geo: $checkedConvert(
        'geo',
        (v) => v == null
      ...
      isPossiblySensitive: $checkedConvert(
        'possibly_sensitive',
        (v) => v as bool?,
      ),
      replySetting: $checkedConvert(
        'reply_settings',
      ...
      editControls: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : TweetEditControls.fromJson(Map<String, Object?>.from(v as Map)),
      ),
      editHistoryTweetIds: $checkedConvert(
      ...
      withheld: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : TweetWithheld.fromJson(Map<String, Object?>.from(v as Map)),
      ),
...
Map<String, dynamic> _$TweetDataToJson(_TweetData instance) =>
    <String, dynamic>{
      'id': instance.id,
      'text': instance.text,
