...
_PrivateTweetMetrics _$PrivateTweetMetricsFromJson(Map json) => $checkedCreate(
  '_PrivateTweetMetrics',
  json,
  ($checkedConvert) {
    final val = _PrivateTweetMetrics(
...
Map<String, dynamic> _$PrivateTweetMetricsToJson(
  _PrivateTweetMetrics instance,
) => <String, dynamic>{
