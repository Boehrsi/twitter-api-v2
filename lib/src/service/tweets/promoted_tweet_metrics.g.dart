...
_PromotedTweetMetrics _$PromotedTweetMetricsFromJson(Map json) =>
    $checkedCreate(
      '_PromotedTweetMetrics',
      json,
      ($checkedConvert) {
        final val = _PromotedTweetMetrics(
          impressionCount: $checkedConvert(
            'impression_count',
            (v) => (v as num).toInt(),
          ),
          likeCount: $checkedConvert('like_count', (v) => (v as num).toInt()),
          retweetCount: $checkedConvert(
            'retweet_count',
            (v) => (v as num).toInt(),
          ),
          replyCount: $checkedConvert('reply_count', (v) => (v as num).toInt()),
          profileClickCount: $checkedConvert(
            'user_profile_clicks',
            (v) => (v as num).toInt(),
          ),
          linkClickCount: $checkedConvert(
            'url_link_clicks',
            (v) => (v as num?)?.toInt(),
          ),
        );
...
Map<String, dynamic> _$PromotedTweetMetricsToJson(
  _PromotedTweetMetrics instance,
) => <String, dynamic>{
