...
_SpaceData _$SpaceDataFromJson(Map json) => $checkedCreate(
  '_SpaceData',
  json,
  ($checkedConvert) {
    final val = _SpaceData(
      id: $checkedConvert('id', (v) => v as String),
      title: $checkedConvert('title', (v) => v as String?),
      state: $checkedConvert(
        'state',
        (v) => $enumDecodeNullable(_$SpaceStateEnumMap, v),
      ),
      creatorId: $checkedConvert('creator_id', (v) => v as String?),
      lang: $checkedConvert(
        'lang',
        (v) => $enumDecodeNullable(_$SpaceLanguageEnumMap, v),
      ),
      hostIds: $checkedConvert(
        'host_ids',
        (v) => (v as List<dynamic>?)?.map((e) => e as String).toList(),
      ),
      topicIds: $checkedConvert(
        'topic_ids',
        (v) => (v as List<dynamic>?)?.map((e) => e as String).toList(),
      ),
      speakerIds: $checkedConvert(
        'speaker_ids',
        (v) => (v as List<dynamic>?)?.map((e) => e as String).toList(),
      ),
      invitedUserIds: $checkedConvert(
        'invited_user_ids',
        (v) => (v as List<dynamic>?)?.map((e) => e as String).toList(),
      ),
...
Map<String, dynamic> _$SpaceDataToJson(_SpaceData instance) =>
    <String, dynamic>{
      'id': instance.id,
